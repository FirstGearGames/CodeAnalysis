...
//
// namespace Roslyn.FishNet.CodeBuilding.RemoteProcedureCalls
// {
...
//         private Methods _serializers => _generator.Serializers;
...
//         }
//
//         public string GetWriteCall(SerializerMethod sm, string writerVariableName, string fieldName, bool closeCall)
//         {
//             if (!sm.IsValid())
//                 return string.Empty;
//
