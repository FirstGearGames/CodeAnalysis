...
namespace FishNet.CodeGenerating
{
    ...
    /// <summary>
    /// Indicates a method is a writer. The first non-extension parameter indicates the type this writer is for.
    /// This attribute is primarily for internal use and may change at anytime without notice.
    /// </summary>
    public class WriterAttribute : Attribute { }
    /// <summary>
    /// Indicates a method is a reader. The return type indicates what type the reader is for.
    /// This attribute is primarily for internal use and may change at anytime without notice.
    /// </summary>
