...
//
//         // UI state
//         private readonly Dictionary<string, bool> detailTreeStates = new(32);
//         private readonly Dictionary<string, bool> packetTreeStates = new(32);
//
...
//         /// </summary>
//         private static readonly List<NetworkProfilerWindow> _instances = new();
//         #endregion
//
...
//             NetworkProfilerWindow window = newInstance || _instances.Count == 0 ? window = CreateInstance<NetworkProfilerWindow>() : _instances[0];
...
//         }
//
//         static readonly Dictionary<Type, object> _deserializedObjects = new();
//
