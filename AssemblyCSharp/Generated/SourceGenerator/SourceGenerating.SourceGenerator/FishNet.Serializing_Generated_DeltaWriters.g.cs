namespace FishNet.Serializing
{
	public static class Generated_DeltaWriters
	{
		...
		public static bool WriteDeltaClientAssembly_Player_MyStructB(this FishNet.Serializing.Writer writer, in ClientAssembly.Player.MyStructB value0, in ClientAssembly.Player.MyStructB value1, bool writeFull = false, bool rootCall = true)
		{
			if (writeFull)
			{
				writer.Write(value1);
