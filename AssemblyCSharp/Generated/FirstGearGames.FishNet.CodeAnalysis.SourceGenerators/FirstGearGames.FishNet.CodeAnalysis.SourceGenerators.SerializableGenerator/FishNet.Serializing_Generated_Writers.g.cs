...
namespace FishNet.Serializing
{
	public static class Generated_Writers
	{
		...
		{
			writer.WriteInt32(TheNumber.value0.TheNumber);
		...
		{
			writer.WriteBoolean(IsBroadcast.value0.IsBroadcast);
		...
		{
			writer.GWrite___WriteClientAssembly_Player_EmptyStruct(Struct.value0.Struct);
			writer.WriteUInt8ArrayAndSize(ByteArr.value0.ByteArr);
			writer.WriteArray[](StructArr.value0.StructArr);
			...
			writer.WriteList<ClientAssembly.Player.NestedStruct>(StructLst.value0.StructLst);
			writer.WriteList<System.ValueTuple<System.Boolean, System.String>>(TupleLst.value0.TupleLst);
			writer.WriteDictionary<ClientAssembly.Player.NestedStruct, System.String>(StructDict.value0.StructDict);
			writer.WriteArraySegmentAndSize(ArrSegment.value0.ArrSegment);
			writer.WriteString(String.value0.String);
		...
		{
			writer.WriteBoolean(Works.value0.Works);
