...
namespace FishNet.Serializing
{
	public static class Generated_Writers
	{
		...
		public static void GWrite___WriteClientAssembly_Player_SimpleStructA(this FishNet.Serializing.Writer writer, ClientAssembly.Player.SimpleStructA value0)
		{
		...
		{
			FishNet.Serializing.GenericWriter<ClientAssembly.Player.SimpleStructA>.SetWrite(new System.Action<FishNet.Serializing.Writer, ClientAssembly.Player.SimpleStructA>(GWrite___WriteClientAssembly_Player_SimpleStructA));
