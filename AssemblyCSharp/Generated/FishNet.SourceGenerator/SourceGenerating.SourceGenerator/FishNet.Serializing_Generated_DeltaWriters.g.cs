namespace FishNet.Serializing
{
	public static class Generated_DeltaWriters
	{
		...
		public static bool GWrite___WriteDeltaClientAssembly_MyThingC(this FishNet.Serializing.Writer writer, ClientAssembly.MyThingC value0, ClientAssembly.MyThingC value1, FishNet.Serializing.DeltaSerializerOption options = FishNet.Serializing.DeltaSerializerOption.Unset)
		{
			...
			if (pooledWriter.WriteDeltaString(value0.C, value1.C))
				totalFlags += 4;
		...
		public static void InitializeSerializers()
		{
			...
			FishNet.Serializing.GenericDeltaWriter<ClientAssembly.MyThingC>.SetWrite(new Func<FishNet.Serializing.Writer, ClientAssembly.MyThingC, ClientAssembly.MyThingC, FishNet.Serializing.DeltaSerializerOption, System.Boolean>(GWrite___WriteDeltaClientAssembly_MyThingC));
		}
	}
}
